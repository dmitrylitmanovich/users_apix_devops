defmodule UsersApixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UsersApixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UsersApixWeb.Gettext, "errors", msg, opts)
    end
  end
